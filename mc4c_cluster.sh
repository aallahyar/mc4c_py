...
echo "submitting jobs for plotting statistics"
    ...
    qsub -hold_jid $jid_dup -P compgen -N mc4c_${cfg_name}_12-OvAProf      -l h_rt=10:00:00 -l h_vmem=25G -pe threaded 1 ~/bulk/bin/run_script.sh "python2 -u mc4c.py QC overallProfile --sigma=1.0 ${cfg_name}"
