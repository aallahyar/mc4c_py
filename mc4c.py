...
def main():
    ...
    if 'PYCHARM_HOSTED' in environ:
        ...
        sys.argv = ['./mc4c.py', 'analysis', 'atAcrossROI', '--n-perm=2', '--test_method=decayCorrector', '--zscr_lim=10', '--sigma=1.0', 'Prdm14_Slc_WT,Prdm14_Slc_WT2,Prdm14_Slc_WT3']
        ...
        # sys.argv = ['./mc4c.py', 'analysis', 'atAcrossROI', '--n-perm=10', '--sigma=1.0', '--test_method=decayCorrector', '--zscr_lim=15', 'LVR-HS2-96x,LVR-HS2-NP,LVR-HS2-NP2']
